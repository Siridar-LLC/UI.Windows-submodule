...
namespace UnityEditor.UI.Windows
{
	...
	public class WindowSystemEditor : Editor
	{
		...
		{
			get { return EditorPrefs.GetInt("UnityEditor.UI.Windows.WindowSystem.TabIndex"); }
			set { EditorPrefs.SetInt("UnityEditor.UI.Windows.WindowSystem.TabIndex", value); }
		}
		...
		public override void OnInspectorGUI()
		{
			...
			GUILayoutExt.DrawComponentHeader(this.serializedObject, "UI", () => { GUILayout.Label("Window System", GUILayout.Height(36f)); }, new Color(0.3f, 0.4f, 0.6f, 0.4f));
		...
		public static void ValidateWindowsResources()
		{
			try
			{
				var isBreak = false;
